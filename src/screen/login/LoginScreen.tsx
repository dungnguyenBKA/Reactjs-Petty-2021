...
import {
    AppStyle,
    background, bold, borderColor,
    borderWidth,
    flexCenter,
    flexCenterInParent,
    flexHori,
    height, margin, marginEnd,
    marginStart,
    marginTop,
    minHeight, minWidth,
    padding,
            ...
            <Column style={
                ...
                <Rows style={AppStyle( {justifyContent: 'space-between'})}>
                    ...
                    <button  style={AppStyle(
                        ...
                        borderWidth(0))}
                             onClick={close}>
                      <img style={{position:'absolute', right: 10, top: 12, zIndex: 2}} src='https://static.xx.fbcdn.net/rsrc.php/v3/y2/r/__geKiQnSG-.png' alt='' width='24' height='24'/>
                    </button>
