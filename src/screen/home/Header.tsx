...
export default function Header(){
    return <div style={AppStyle({ backgroundImage: `url(${bgHome})` }, paddingBottom(20))}>
        <div style={AppStyle(flexHori(), flexCenter(), marginHori(15))}>
            <ImageView style={AppStyle(circleImage(42))} src="https://avatar-ex-swe.nixcdn.com/singer/avatar/2018/05/05/5/6/0/3/1525531851818_600.jpg"/>
            ...
            <div style={AppStyle(flexHori())}>
                <ImageView style ={AppStyle(width(20), height(20), marginEnd(4))}src={icCoin}/>
        ...
        <div style={AppStyle(weightItem(1), flexVerti(), flexCenter())}>
            <ImageView style={AppStyle(width(32), height(32), fitContain())} 
            src={icScan}/>
            <p>Quet QR</p>
        </div>   
        <div style={AppStyle(weightItem(1),flexVerti(), flexCenter())}>
            <ImageView style={AppStyle(width(32), height(32), fitContain())} src={icPetAdd}/>
            <p>Them Pet</p>
        </div>   
        <div style={AppStyle(weightItem(1),flexVerti(), flexCenter())}>
            <ImageView style={AppStyle(width(32), height(32), fitContain())} src={icPetCard}/>
            <p>The Pet</p>
        </div>   
        <div style={AppStyle(weightItem(1),flexVerti(), flexCenter())}>
            <ImageView style={AppStyle(width(32), height(32), fitContain())} src={icAddFriend}/>
            <p>Moi ban be</p>
        </div>   
         </div>
