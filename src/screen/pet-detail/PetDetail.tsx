	...
	return <Column style={AppStyle(border(Colors.color_E5E5E5))}>
		...
		<InfoBox>
			<Column>
				...
				<TextView style={AppStyle(semiBold(14))}>Vinhomes Smart City, Tây Mỗ Đại Mỗ, Tây Mỗ, Từ Liêm, Hà
					Nội</TextView>
			</Column>
		</InfoBox>
		...
		<InfoBox>
			<Column>
				...
				<TextView
					style={AppStyle(semiBold(14), textColor(Colors.color_primary))}>Hello {params.petId}</TextView>
			</Column>
		</InfoBox>
